    ...
    return (
        <HomeLayout heading={"Login to your account"} image={loginImg}>
            <div className="space-y-7">
                ...
                <div className="px-5 flex justify-between">
                    <div className="flex items-center gap-4">
                        <input id="rememberMe" type="checkbox" className="border border-gray-300 rounded-md w-6 h-6" />
            ...
            <div className="flex justify-evenly">
                ...
                <div className="rounded-full p-2 bg-white" to={"#"}> <img className="rounded-full h-5" src={twitter} alt="twitter" /> </div>
